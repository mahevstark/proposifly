...
export default function AdminSidebar() {
  ...
  return (
    <aside
      className="w-[260px] min-h-screen hidden md:flex flex-col"
    ...
    >
      ...
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-[14px] font-semibold tracking-tight" style={{ color: "#f1f1f3" }}>Proposifly</h2>
      ...
      <nav className="flex-1 px-3 py-2 space-y-0.5">
        <p className="text-[9px] font-semibold uppercase tracking-[0.16em] px-3 mb-2" style={{ color: "rgba(255,255,255,0.2)" }}>Navigation</p>
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              style={{
                ...
                color: isActive ? "#f1f1f3" : "rgba(255,255,255,0.38)",
              }}
              onMouseEnter={e => { if (!isActive) (e.currentTarget as HTMLElement).style.color = "rgba(255,255,255,0.68)"; }}
            ...
            >
              ...
              <svg
                ...
                style={{ color: isActive ? "#f97316" : "rgba(255,255,255,0.28)" }}
      ...
      <div className="p-4" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <div className="flex items-center gap-2.5 px-1 py-2 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[12px] font-medium truncate" style={{ color: "rgba(255,255,255,0.75)" }}>{user?.name || "Admin"}</p>
        ...
        <Link
          ...
          onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = "rgba(255,255,255,0.35)"; (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.02)"; }}
        >
